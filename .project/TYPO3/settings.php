...
return [
    'BE' => [
        'debug' => false,
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$MFlyUWQ2LlM4Wm1EemF5ag$K3CLh/LC32ufkXg6KBkM+LFe91rJIfh3h1hLaYwICJM',
        'passwordHashing' => [
    ...
    'SYS' => [
        ...
        'sitename' => 'in2frontendauthentication DEV',
        'systemMaintainers' => [
            1,
        ],
    ],
