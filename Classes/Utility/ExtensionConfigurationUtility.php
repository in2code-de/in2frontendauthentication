...
class ExtensionConfigurationUtility
{
     ...
     * @return mixed
     */
    public static function getExtensionConfiguration($path, $extensionKey = 'in2frontendauthentication')
    {
        $version =
     ...
     * @return bool
     */
    public static function isSfcCookie()
    {
        return (boolean)self::getExtensionConfiguration('set_sfc_cookie');
    }
}
